...
describe('Info controller integration tests', () => {
	...
	it(`Should return no content when a get request is made to /resolvers
      but no resolvers have been uploaded`, async () => {
		...
		await agent.get('/api/v1/info/proj1/resolvers').expect(204);
	});
	...
	it(`Should return no content when a get request is made to /dependencies
      but no dependency has been uploaded`, async () => {
		...
		await agent.get('/api/v1/info/proj1/dependencies').expect(204);
	});
	...
	it(`Should return no content when a get request is made to /schema
      but no schema has been uploaded`, async () => {
		...
		await agent.get('/api/v1/info/proj1/schema').expect(204);
	});
